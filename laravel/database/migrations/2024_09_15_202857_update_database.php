...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('posts', function (Blueprint $table) {
            ...
            $table->foreign('like_id')->references('like_id')->on('likes')->onDelete('cascade');
        ...
        Schema::table('comments', function (Blueprint $table) {
            $table->foreignId('parent_id')->nullable()->references('comment_id')->on('comments')->onDelete('cascade'); 
        });
    }
